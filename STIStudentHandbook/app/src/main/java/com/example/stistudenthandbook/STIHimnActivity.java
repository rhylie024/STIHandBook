...
public class STIHimnActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_s_t_i_himn);
        ...
        Stopbtn = findViewById(R.id.btnStop);
         ...
         Playbtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (sti_hym==null)
                {
                    sti_hym = MediaPlayer.create(getApplicationContext(),R.raw.sti_hymn);
                    sti_hym.start();
                }
